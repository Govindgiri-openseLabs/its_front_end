...
function ImageMapComponent() {
    ...
    const toggleBodyPart = (event, side) => {
      ...
      if (side === 'front') {
        ...
        //   updatedFrontArray.splice(existingIndex, 1);
          ...
          updatedFrontArray.push({ type: "Internal Injury", injury: bodyPartId });
        }
      ...
      if (side === 'back') {
        ...
        //   updatedBackArray.splice(existingIndex, 1);
          ...
          // Add the body part with a default type of "normal"
          updatedBackArray.push({ type: "normal", injury: bodyPartId });
        }
        ...
        if(side==='front'){
                        ...
                        if(existingIndex==-1)
                        {
                        update_front_body_circle_array.push({ X:event.clientX,Y:event.clientY,injury:bodyPartId})
        ...
        if(side==='back'){
                        ...
                        if(existingIndex==-1)
                        {
                            update_back_body_circle_array.push({ X:event.clientX,Y:event.clientY,injury:bodyPartId})
 ...
 <div className="image-map-container">
            <div className='front_image_container'>
            ...
            <div className='front_circle_tag'>
                {   
                   ...
                   return <div style={{"width":"100px","height":"100px","border-radius":"50%","position":"absolute","left":item.X-242,"top":item.Y-53,"background-color":"red","opacity":"0.4"}}>govind</div>
                })
                }
            </div>
            ...
            <div className='list-container'> 
                ...
                <button onClick={()=>submitItems('front')}>Submit</button>
                <button onClick={()=>submitItems('front')}>Save</button>
            </div>
    </div>
    <div className='back_image_container'>
            ...
            <div className='back_circle_tag'>
                {   
                   ...
                   return <div style={{"width":"100px","height":"100px","border-radius":"50%","position":"absolute","left":item.X-242,"top":item.Y+920,"background-color":"red","opacity":"0.4"}}>govind</div>
                })
                }
            </div>
            <div><span style={{"fontSize":"40px","position":"relative","bottom":"20px"}}>Add Injury</span> <img src={clickImage} style={{"width":"70px","height":"70px"}}></img></div>
            ...
            <div className='list-container'> 
                ...
                <button onClick={()=>submitItems('back')}>Submit</button>
                <button onClick={()=>submitItems('back')}>Save</button>
            </div>
      </div>
  </div>  
